...
| Role | Responsibility |
|------|----------------|
| **Butler** | Primary human interface. Entry point for most interactions — when you broadly know what you want. Can scope to a specific project or operate across all of them. Routes interactive persona sessions and, in v0.1, handles worker dispatch directly (no Foreman layer). |
